...
const NoticeView = () => {
  ...
  return (
        <div className="noticeView-container">
            ...
            <div className="titleText">{notice.title}</div>
                            ...
                            {editingCommentId === comment.id ? (
                                <div className='comment-box'>
                                    ...
                                    <div className='btn-box'>
                                        <button className='editbtn btn' onClick={() => handleUpdateComment(comment.id)}>수정 완료</button>
                                        <button className='deletebtn btn' onClick={() => setEditingCommentId(null)}>취소</button>
                                    </div>
                                </div>
                            ) : (
                                <div className='comment-box'>
                                    ...
                                    {user && comment.author.id === user.id && editingCommentId !== comment.id && (
                                        <div className='btn-box'>
                                            <button className='editbtn btn' onClick={() => handleEditComment(comment)}>수정</button>
                                            <button className='deletebtn btn' onClick={() => handleDeleteComment(comment.id)}>삭제</button>
                                        </div>
                                    )}
                                </div>
                            )}
